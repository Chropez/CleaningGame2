  ...
  <Box p={4}>
    ...
    <ul>
      ...
      <li>
        ...
        "Us" or "Our" in this Agreement) refers to Städspelet.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Städspelet, accessible from
        https://stadspelet.firebaseapp.com/
      </li>
      <li>
